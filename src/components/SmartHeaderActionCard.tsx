...
export function SmartHeaderActionCard({ action, compact, embedded, isDark, onDismiss, onLongPressAction, onQuickLog }: SmartHeaderActionCardProps): JSX.Element {
  ...
  return (
    <Pressable
      accessibilityRole={onLongPressAction ? "button" : undefined}
      onLongPress={onLongPressAction ? () => onLongPressAction(action) : undefined}
      style={({ pressed }) => [styles.card, compact && styles.cardCompact, embedded && styles.cardEmbedded, surfaceStyle, pressed && onLongPressAction && styles.pressed]}
    >
